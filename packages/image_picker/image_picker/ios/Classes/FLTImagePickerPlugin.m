...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if ([@"pickImage" isEqualToString:call.method]) {
        ...
        if([[_arguments objectForKey:@"requestedExportQuality"] isKindOfClass:[NSNumber class]]){
            int quality = [[_arguments objectForKey:@"requestedExportQuality"] intValue];
            if (@available(iOS 11.0, *)) {
                switch (quality) {
                    case 0:
                        _imagePickerController.videoExportPreset = AVAssetExportPresetLowQuality;
                        break;
                    case 1:
                        _imagePickerController.videoExportPreset = AVAssetExportPresetMediumQuality;
                        break;
                    case 2:
                        _imagePickerController.videoExportPreset = AVAssetExportPresetHighestQuality;
                        break;
                    case 3:
